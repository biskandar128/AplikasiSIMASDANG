...
<html lang="en">
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a href="<?= base_url('user/register'); ?>">  
                  <button class="btn btn-daftar my-2 my-sm-0 mr-2" type="button">
                    Daftar
                  </button>
                </a>
              </li>
              <li class="nav-item">
                ...
                <a href="<?= base_url('user/login'); ?>">
                  <button class="btn btn-masuk my-2 my-sm-0" type="button">
                    Masuk
                  </button>
                </a>
              </li>
          ...
          <div class="row d-block d-sm-block d-md-block d-lg-none">
            <div class="container-fluid">
              ...
              <a href="<?= base_url('user/register'); ?>">
                <button class="btn btn-daftar my-2 my-sm-0" type="button">
                  Daftar
                </button>
              </a>
            </div>
        ...
        <section class="section-about" id="tentang_kami">
          ...
          <div class="row">
            ...
            <div class="col-md-7 col-6">
              ...
              <button class="btn btn-about">Lihat Detail</button>
            </div>
          </div>
        </section>
      </div>
              ...
              <div class="col-md-6 col-6 d-flex justify-content-center">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text" style="font-size: 20px"><strong>Rp<?= number_format($product->harga, 0, '', '.'); ?></strong></p>
                    <a href="<?= base_url('produk_detail/'.$product->goods_id); ?>" class="btn w-100 btn-beli"
                      >Beli</a
                    >
                  </div>
                </div>
    ...
    <script src="<?= base_url('asset/Frontend/assets/vendor/slick-1.8.1/slick/slick.min.js'); ?>"></script>
